...
Persistent sandboxes are available in [Beta](/docs/release-phases#beta) on [all plans](/docs/plans)
...
## [How persistent sandboxes differ from ephemeral sandboxes](#how-persistent-sandboxes-differ-from-ephemeral-sandboxes)
...
### [Default snapshot expiration](#default-snapshot-expiration)
...
### [Create a persistent sandbox (or opt out)](#create-a-persistent-sandbox-or-opt-out)
...
### [Update sandbox configuration](#update-sandbox-configuration)
...
### [List and search sandboxes](#list-and-search-sandboxes)
...
## [SDK breaking changes](#sdk-breaking-changes)
...
### [New SDK methods](#new-sdk-methods)
...
### [New SDK properties](#new-sdk-properties)
...
### [New `Sandbox.list()` parameters](#new-sandbox.list-parameters)
...
### [New `Snapshot.list()` parameter](#new-snapshot.list-parameter)
...
### [Create a persistent sandbox](#create-a-persistent-sandbox)
...
### [Run a command with automatic resume](#run-a-command-with-automatic-resume)
...
### [Inspect sessions](#inspect-sessions)
...
## [Managing persistent sandboxes in the dashboard](#managing-persistent-sandboxes-in-the-dashboard)
...
## [Migration from stable to beta](#migration-from-stable-to-beta)
...
While the backfill is running, some older sandboxes may not appear when using
the beta SDK or CLI.
