...
| --- | --- | --- | --- |
| [Sandbox Active CPU](#active-cpu) | 5 hours/month | $0.128/hour | $0.128/hour |
| [Sandbox Provisioned Memory](#provisioned-memory) | 420 GB-hours/month | $0.0212/GB-hour | $0.0212/GB-hour |
| [Sandbox Creations](#sandbox-creations) | 5,000/month | $0.60/1M | $0.60/1M |
| [Sandbox Data Transfer](#network) | 20 GB/month | $0.15/GB | $0.15/GB |
| [Sandbox Storage](#snapshot-storage) | 15 GB (lifetime) | $0.08/GB-month | $0.08/GB-month |
| [Max Runtime Duration](#runtime-limits) | 45 minutes | 5 hours | 5 hours |
| [Concurrent Sandboxes](#concurrency-limits) | 10 | 2,000 | 2,000 |
| [vCPU Allocation Rate](#rate-limits) | 40/10 min | 200/min | 400/min |
...
You can provision 1 or an even number of vCPUs between 2 and 32 [depending on your plan](/docs/vercel-sandbox/pricing#resource-limits). The default is 2 vCPUs.
...
### [Sandbox Creations](#sandbox-creations)
...
Each sandbox is automatically provisioned 32 GB of ephemeral NVMe storage. You can use [persistent sandboxes](/docs/vercel-sandbox/concepts/persistent-sandboxes) or manually create [snapshots](/docs/vercel-sandbox/concepts/snapshots) to persist data across sandboxes.
...
The number of vCPUs you can allocate to new sandboxes is rate-limited by plan. For example, with the Pro plan limit of 200 vCPUs per minute, you can create 25 sandboxes with 8 vCPUs each, or 100 sandboxes with 2 vCPUs each, every minute.
...
System Specifications](/docs/vercel-sandbox/system-specifications)[Next

Run Commands in Vercel Sandbox](/docs/vercel-sandbox/run-commands-in-sandbox)
