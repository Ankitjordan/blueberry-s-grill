...
This webhook does not fire immediately when a deployment is marked for
...
This event gets fired after a production deployment is
...
This event confirms Vercel accepted your request. You might receive it before
...
This event gets fired after all blocking Checks have passed. See [`deployment-prepared`](/docs/integrations#webhooks/events/deployment-prepared) if you registered
Checks.
...
### [integration-configuration.transferred](#integration-configuration.transferred)
...
### [marketplace.invoice.overdue](#marketplace.invoice.overdue)
...
This event is sent only when the Integration has access to all projects in a
Vercel scope.
...
### [project.env-variable.created](#project.env-variable.created)
...
### [project.env-variable.updated](#project.env-variable.updated)
...
### [project.env-variable.deleted](#project.env-variable.deleted)
...
### [flag.segment.created](#flag.segment.created)
...
### [flag.segment.updated](#flag.segment.updated)
...
### [flag.segment.deleted](#flag.segment.deleted)
...
This event gets fired after all blocking checks have passed. See [`deployment-prepared`](/docs/integrations#webhooks/events-types/deployment-prepared) if you
registered Checks.
...
This event has been removed. [deployment.succeeded](#deployment.succeeded) can
...
For enhanced security against timing attacks, use constant-time comparison
...
Webhooks](/docs/webhooks)[Next

CDN / Overview](/docs/cdn)
