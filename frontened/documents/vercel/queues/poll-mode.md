...
## [When to use poll mode](#when-to-use-poll-mode)

Poll mode is designed for two main scenarios:

### [Consuming off Vercel](#consuming-off-vercel)
...
### [Advanced on-Vercel setups](#advanced-on-vercel-setups)
...
### [Example: multiplayer AI agent replay](#example:-multiplayer-ai-agent-replay)
...
## [Versioning with deployment IDs](#versioning-with-deployment-ids)
...
## [Comparison with push mode](#comparison-with-push-mode)
...
Observability](/docs/queues/observability)[Next
