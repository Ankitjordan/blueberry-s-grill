...
## [Consuming messages (push mode)](#consuming-messages-push-mode)
...
The SDK defaults `visibilityTimeoutSeconds` to 300 seconds (5 minutes) and automatically re-extends the lease while your handler is still running. The underlying [Queues API](/docs/queues#visibility-timeout) defaults to 60 seconds and does not auto-extend.

### [Custom retry behavior](#custom-retry-behavior)
...
Concepts](/docs/queues/concepts)[Next
