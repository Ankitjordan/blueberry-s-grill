...
## [Vercel Queues overview](#vercel-queues-overview)
...
## [Vercel Queues vs Workflows](#vercel-queues-vs-workflows)
...
## [How Vercel Queues works](#how-vercel-queues-works)
...
## [Topics and consumer groups](#topics-and-consumer-groups)
...
## [Regions and data residency](#regions-and-data-residency)
...
Strict data residency (guaranteeing data never leaves the selected region, even temporarily during failover) is not supported yet.

## [Deployments and versioning](#deployments-and-versioning)
...
In [poll mode](/docs/queues/poll-mode), you can reference the deployment ID as an opaque version identifier to partition your consumers manually, or omit it entirely and handle versioning at the application level.
...
### [Consumer function security](#consumer-function-security)
...
Messages cannot be consumed after their TTL expires. If a message's delay would extend beyond its TTL, the message will expire before it becomes visible and will never be delivered.

#### [Delays longer than 7 days](#delays-longer-than-7-days)
...
### [Concurrency control (push mode)](#concurrency-control-push-mode)
...
Quickstart](/docs/queues/quickstart)[Next
