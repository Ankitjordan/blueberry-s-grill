...
Trace Drains use the [OTLP/HTTP](https://opentelemetry.io/docs/specs/otlp/#otlphttp) protocol exclusively. OTLP/gRPC endpoints (typically port 4317) are not supported. Make sure your endpoint accepts OTLP/HTTP requests (typically port 4318, path `/v1/traces`).
...
Logs](/docs/drains/reference/logs)[Next
