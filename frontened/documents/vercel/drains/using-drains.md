...
4. ### [Configure the sampling rules (optional)](#configure-the-sampling-rules-optional)
...
5. ### [Configure destination](#configure-destination)
...
6. ### [Create the drain](#create-the-drain)
...
Reference / Logs](/docs/drains/reference/logs)
