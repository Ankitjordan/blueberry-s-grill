...
| --- | --- | --- |
| [Workflow Steps](/docs/workflows/pricing) | First 50,000 Steps | $2.50 per 100K Steps |
| [Workflow Data Retained](/docs/workflows/pricing) | — | $0.00069 per GB per hour |
...
## [Workflow run limits](#workflow-run-limits)
...
### [Vercel platform limits](#vercel-platform-limits)
