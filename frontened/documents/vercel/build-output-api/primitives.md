...
### [Directory structure for Functions](#directory-structure-for-functions)
...
## [Functions with Edge Runtime](#functions-with-edge-runtime)
...
### [Function with Edge Runtime configuration](#function-with-edge-runtime-configuration)
...
#### [Function with Edge Runtime config example](#function-with-edge-runtime-config-example)
...
### [Directory structure for Functions with Edge Runtime](#directory-structure-for-functions-with-edge-runtime)
...
Features](/docs/build-output-api/features)[Next
