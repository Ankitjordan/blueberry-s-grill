...
### [Provider metadata output](#provider-metadata-output)
...
### [Combining `sort` with `order` and `only`](#combining-sort-with-order-and-only)
...
### [How sort interacts with provider health](#how-sort-interacts-with-provider-health)
