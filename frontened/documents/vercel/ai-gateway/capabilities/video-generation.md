...
## [Extending timeouts for Node.js](#extending-timeouts-for-node.js)
...
### [Global default provider](#global-default-provider)
...
Text-to-Video](/docs/ai-gateway/capabilities/video-generation/text-to-video)
