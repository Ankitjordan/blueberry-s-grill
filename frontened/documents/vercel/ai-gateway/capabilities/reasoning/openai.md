...
### [Streaming with reasoning summaries](#streaming-with-reasoning-summaries)
...
Some models default to `none` for reasoning effort, meaning reasoning is
...
Reasoning](/docs/ai-gateway/capabilities/reasoning)[Next

Anthropic](/docs/ai-gateway/capabilities/reasoning/anthropic)
