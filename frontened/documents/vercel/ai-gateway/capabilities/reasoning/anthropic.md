...
## [Two thinking modes](#two-thinking-modes)
...
### [Effort levels (adaptive thinking)](#effort-levels-adaptive-thinking)
...
Requests using an unsupported effort level for a model return an error. For
...
### [Adaptive thinking (Claude 4.6 and later)](#adaptive-thinking-claude-4.6-and-later)
...
### [Extended thinking (Claude 4.6 and earlier)](#extended-thinking-claude-4.6-and-earlier)
...
## [Thinking display (Claude Opus 4.7 and later)](#thinking-display-claude-opus-4.7-and-later)
...
## [Summarized vs. full thinking](#summarized-vs.-full-thinking)
...
OpenAI](/docs/ai-gateway/capabilities/reasoning/openai)[Next

Google / Vertex](/docs/ai-gateway/capabilities/reasoning/google)
