...
### [Adaptive reasoning (Claude 4.6 and later)](#adaptive-reasoning-claude-4.6-and-later)
...
### [Manual reasoning (Claude 4.6 and earlier)](#manual-reasoning-claude-4.6-and-earlier)
...
Google / Vertex](/docs/ai-gateway/capabilities/reasoning/google)[Next

Reranking](/docs/ai-gateway/capabilities/reranking)
