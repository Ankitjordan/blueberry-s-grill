...
## [Applying user and tag info to requests](#applying-user-and-tag-info-to-requests)
...
#### [Chat Completions (OpenAI SDK)](#chat-completions-openai-sdk)
...
#### [Responses (OpenAI SDK)](#responses-openai-sdk)
...
#### [Anthropic SDK (Messages)](#anthropic-sdk-messages)
...
#### [Direct HTTP (OpenResponses and raw requests)](#direct-http-openresponses-and-raw-requests)
...
## [Custom Reporting API reference](#custom-reporting-api-reference)
...
## [Querying reports with the AI SDK](#querying-reports-with-the-ai-sdk)
...
### [Group by model per hour](#group-by-model-per-hour)
...
### [Group by credential type](#group-by-credential-type)
...
### [Filter by user, model, or tags](#filter-by-user-model-or-tags)
