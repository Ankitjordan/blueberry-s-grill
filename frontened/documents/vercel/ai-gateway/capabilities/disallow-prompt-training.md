...
Disallow prompt training enforcement does not apply to [BYOK (Bring Your Own
...
If we do not know a provider's training data stance or have not yet
...
## [Disallow prompt training per request](#disallow-prompt-training-per-request)
...
## [Disallow prompt training providers](#disallow-prompt-training-providers)
...
Zero Data Retention](/docs/ai-gateway/capabilities/zdr)[Next

Service Tiers](/docs/ai-gateway/capabilities/service-tiers)
