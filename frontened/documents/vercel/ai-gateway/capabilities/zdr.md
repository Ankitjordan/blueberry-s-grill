...
ZDR enforcement does not apply to [BYOK (Bring Your Own
...
If we do not know a provider's ZDR stance or have not yet established an
...
## [Team-wide zero data retention](#team-wide-zero-data-retention)
...
## [Per-request zero data retention](#per-request-zero-data-retention)
...
### [Using the Chat Completions API](#using-the-chat-completions-api)
...
### [Using the Anthropic Messages API](#using-the-anthropic-messages-api)
...
### [Using the OpenResponses API](#using-the-openresponses-api)
...
## [Using both account and request-level ZDR](#using-both-account-and-request-level-zdr)
...
## [Caching and zero data retention](#caching-and-zero-data-retention)
...
## [ZDR providers and policies](#zdr-providers-and-policies)
...
Reranking](/docs/ai-gateway/capabilities/reranking)[Next
