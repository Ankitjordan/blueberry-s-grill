...
## [Reasoning with provider fallbacks](#reasoning-with-provider-fallbacks)
...
Embeddings](/docs/ai-gateway/capabilities/embeddings)[Next

OpenAI](/docs/ai-gateway/capabilities/reasoning/openai)
