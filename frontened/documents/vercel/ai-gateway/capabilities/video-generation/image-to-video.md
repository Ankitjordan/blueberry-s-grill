...
### [KlingAI parameters](#klingai-parameters)
...
### [KlingAI image requirements](#klingai-image-requirements)
...
### [KlingAI example](#klingai-example)
...
### [KlingAI first and last frame](#klingai-first-and-last-frame)
...
### [KlingAI voice generation](#klingai-voice-generation)
...
### [KlingAI camera control](#klingai-camera-control)
...
### [KlingAI motion brush](#klingai-motion-brush)
...
### [KlingAI multi-shot](#klingai-multi-shot)
...
## [ByteDance Seedance](#bytedance-seedance)
...
### [Seedance parameters](#seedance-parameters)
...
### [Seedance example](#seedance-example)
...
### [Seedance first and last frame](#seedance-first-and-last-frame)
...
### [Seedance multi-reference images](#seedance-multi-reference-images)
...
Text-to-Video](/docs/ai-gateway/capabilities/video-generation/text-to-video)[Next

Reference-to-Video](/docs/ai-gateway/capabilities/video-generation/reference-to-video)
