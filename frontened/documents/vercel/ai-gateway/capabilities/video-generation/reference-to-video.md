...
### [Wan example with Vercel Blob](#wan-example-with-vercel-blob)
...
Image-to-Video](/docs/ai-gateway/capabilities/video-generation/image-to-video)[Next

Motion Control](/docs/ai-gateway/capabilities/video-generation/motion-control)
