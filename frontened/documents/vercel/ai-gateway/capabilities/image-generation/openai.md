...
### [Generate response format](#generate-response-format)
...
Using AI SDK](/docs/ai-gateway/capabilities/image-generation/ai-sdk)[Next

Video Generation](/docs/ai-gateway/capabilities/video-generation)
