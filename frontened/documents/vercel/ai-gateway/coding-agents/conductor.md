...
## [Configuring Conductor](#configuring-conductor)
...
2. ### [Configure environment variables](#configure-environment-variables)
   ...
   Setting `ANTHROPIC_API_KEY` to an empty string is required. This prevents
...
3. ### [Start using Conductor](#start-using-conductor)
