...
## [Configuring Roo Code](#configuring-roo-code)

1. ### [Create an API key](#create-an-api-key)

   Go to the [AI Gateway](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fai-gateway&title=Go+to+AI+Gateway) section in the Vercel dashboard sidebar and click API keys to create a new API key.
2. ### [Install Roo Code](#install-roo-code)
...
3. ### [Open Roo Code settings](#open-roo-code-settings)
...
4. ### [Configure AI Gateway](#configure-ai-gateway)
   ...
   Roo Code automatically updates to include the models available on AI Gateway. Browse the full catalog on the [models page](https://vercel.com/ai-gateway/models).
