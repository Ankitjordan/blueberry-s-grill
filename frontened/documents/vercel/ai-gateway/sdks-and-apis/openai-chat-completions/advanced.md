...
#### [Request-scoped BYOK (Bring Your Own Key)](#request-scoped-byok-bring-your-own-key)
...
Credential precedence: When request-scoped BYOK credentials are provided,
...
Cache control types: The `ephemeral` cache type stores content for the
...
Structured Outputs](/docs/ai-gateway/sdks-and-apis/openai-chat-completions/structured-outputs)[Next

Embeddings](/docs/ai-gateway/sdks-and-apis/openai-chat-completions/embeddings)
