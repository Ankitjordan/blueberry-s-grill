...
## [Image-only models (different endpoint)](#image-only-models-different-endpoint)
...
Image generation support: Multimodal image output through Chat Completions
...
Embeddings](/docs/ai-gateway/sdks-and-apis/openai-chat-completions/embeddings)[Next

REST API](/docs/ai-gateway/sdks-and-apis/openai-chat-completions/rest-api)
