...
Check your installed version with `npm list ai`. To upgrade, run `npm install ai@latest`. See the [AI SDK v6 migration guide](https://ai-sdk.dev/docs/migration-guides/migration-guide-6-0) for upgrade details.
...
OpenAI Responses API](/docs/ai-gateway/sdks-and-apis/responses)
