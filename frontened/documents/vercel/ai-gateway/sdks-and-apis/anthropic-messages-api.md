...
1. ### [Configure environment variables](#configure-environment-variables)
   ...
   Setting `ANTHROPIC_API_KEY` to an empty string is important. Claude Code
...
The examples and content in this section are not comprehensive. For complete
...
The `cache_control` parameter is passed through to Anthropic, Vertex AI Anthropic, and Amazon Bedrock Anthropic models for explicit caching. Other providers or models with implicit caching work automatically without any configuration.
...
### [Where to place cache breakpoints](#where-to-place-cache-breakpoints)
...
OpenAI Chat Completions API](/docs/ai-gateway/sdks-and-apis/openai-chat-completions)[Next

Messages](/docs/ai-gateway/sdks-and-apis/anthropic-messages-api/messages)
