...
## [Configuring OpenClaw (Clawdbot)](#configuring-openclaw-clawdbot)

1. ### [Create an API key](#create-an-api-key)

   Go to the [AI Gateway](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fai-gateway&title=Go+to+AI+Gateway) section in the Vercel dashboard sidebar and click API keys to create a new API key.
2. ### [Install OpenClaw (Clawdbot)](#install-openclaw-clawdbot)
...
3. ### [Run onboarding wizard](#run-onboarding-wizard)
...
LibreChat](/docs/ai-gateway/chat-platforms/librechat)[Next

Chatbox](/docs/ai-gateway/chat-platforms/chatbox)
