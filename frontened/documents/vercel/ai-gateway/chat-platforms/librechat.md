...
## [Configuring LibreChat](#configuring-librechat)

1. ### [Create an API key](#create-an-api-key)

   Go to the [AI Gateway](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fai-gateway&title=Go+to+AI+Gateway) section in the Vercel dashboard sidebar and click API keys to create a new API key.
2. ### [Install LibreChat](#install-librechat)
...
3. ### [Create Docker override file](#create-docker-override-file)
...
4. ### [Add API key to environment](#add-api-key-to-environment)
...
5. ### [Configure custom endpoint](#configure-custom-endpoint)
   ...
   Setting `fetch: true` automatically fetches all available models from AI Gateway. Browse the full catalog on the [models page](https://vercel.com/ai-gateway/models).
6. ### [Start LibreChat](#start-librechat)
...
7. ### [Select AI Gateway endpoint](#select-ai-gateway-endpoint)
...
8. ### [(Optional) Monitor usage and spend](#optional-monitor-usage-and-spend)
...
Chat Platforms](/docs/ai-gateway/chat-platforms)[Next

OpenClaw (Clawdbot)](/docs/ai-gateway/chat-platforms/openclaw)
