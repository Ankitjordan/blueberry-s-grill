...
If your client needs to establish a WebSocket connection, connect using HTTPS
...
## [How Vercel handles certificates](#how-vercel-handles-certificates)
...
Security](/docs/cdn-security)[Next
