...
URL Source: https://vercel.com/docs/integrations/cms/butter-cms

Markdown Content:
# Vercel ButterCMS Integration
[Skip to content](https://vercel.com/docs/integrations/cms/butter-cms#geist-skip-nav)
...
*   Integrations Expand menu 
    ...
    *   [Install an Integration](https://vercel.com/docs/integrations/install-an-integration) Expand menu 
    *   [Create an Integration](https://vercel.com/docs/integrations/create-integration) Expand menu 
    ...
    *   [Commerce and Payments](https://vercel.com/docs/integrations/ecommerce) Expand menu 
...
## [Getting started](https://vercel.com/docs/integrations/cms/butter-cms#getting-started)[](https://vercel.com/docs/integrations/cms/butter-cms#getting-started)

To get started with the ButterCMS on Vercel deploy the template below:

[![Image 3: Next.JS ButterCMS Starter Project](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F3M9Q0UMYCuodFBOXTMLxPr%2F58fba6c49550df129bac7f1bec502cd6%2FButter_Vercel_Thumbnail_Compressed_-_Maria_Violante.png&w=3840&q=75) Next.JS ButterCMS Starter Project A fully-functional, drop-in proof-of-concept Next.js app, fully integrated with your ButterCMS account](https://vercel.com/templates/next.js/NextJS-starter-buttercms)

Open in v0

Or, follow the steps below to install the integration:

1.   ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/butter-cms#install-the-vercel-cli)[](https://vercel.com/docs/integrations/cms/butter-cms#install-the-vercel-cli) 
To pull in environment variables from ButterCMS to your Vercel project, you need to install the [Vercel CLI](https://vercel.com/docs/cli). Run the following command in your terminal:
 ...
 Terminal ![Image 4](https://7nyt0uhk7sse4zvn.public.blob.vercel-storage.com/docs-assets/static/topics/icons/pnpm.svg)        `pnpm i -g vercel@latest`     `yarn global add vercel@latest`     `npm i -g vercel@latest`     `bun add -g vercel@latest`   
2.   ### [Install your CMS integration](https://vercel.com/docs/integrations/cms/butter-cms#install-your-cms-integration)[](https://vercel.com/docs/integrations/cms/butter-cms#install-your-cms-integration) 
...
3.   ### [Pull in environment variables](https://vercel.com/docs/integrations/cms/butter-cms#pull-in-environment-variables)[](https://vercel.com/docs/integrations/cms/butter-cms#pull-in-environment-variables) 
...
[Previous Agility CMS](https://vercel.com/docs/integrations/cms/agility-cms)[Next Contentful](https://vercel.com/docs/integrations/cms/contentful)
