...
URL Source: https://vercel.com/docs/integrations/cms/sanity

Markdown Content:
# Vercel Sanity Integration
[Skip to content](https://vercel.com/docs/integrations/cms/sanity#geist-skip-nav)
...
## [Getting started](https://vercel.com/docs/integrations/cms/sanity#getting-started)[](https://vercel.com/docs/integrations/cms/sanity#getting-started)

To get started with the Sanity on Vercel deploy the template below:

[![Image 3: Stablo – Minimal Blog Template](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F6p72KDrdJ8SjyvOBrgRbnr%2F0760db43f2cb08504a2f67601e74d986%2FCleanShot_2022-07-15_at_16.54.17.png&w=3840&q=75) Stablo – Minimal Blog Template A minimal blog website template built with Next.js, TailwindCSS & Sanity CMS](https://vercel.com/templates/next.js/stablo-blog)

Open in v0

Or, follow the steps below to install the integration:

1.   ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/sanity#install-the-vercel-cli)[](https://vercel.com/docs/integrations/cms/sanity#install-the-vercel-cli) 
...
2.   ### [Install your CMS integration](https://vercel.com/docs/integrations/cms/sanity#install-your-cms-integration)[](https://vercel.com/docs/integrations/cms/sanity#install-your-cms-integration) 
Navigate to the [Sanity integration](https://vercel.com/integrations/sanity) and follow the steps to install the integration.

3.   ### [Pull in environment variables](https://vercel.com/docs/integrations/cms/sanity#pull-in-environment-variables)[](https://vercel.com/docs/integrations/cms/sanity#pull-in-environment-variables) 
...
### [Content Link](https://vercel.com/docs/integrations/cms/sanity#content-link)[](https://vercel.com/docs/integrations/cms/sanity#content-link)
...
[Previous Makeswift](https://vercel.com/docs/integrations/cms/makeswift)[Next Sitecore](https://vercel.com/docs/integrations/cms/sitecore)
