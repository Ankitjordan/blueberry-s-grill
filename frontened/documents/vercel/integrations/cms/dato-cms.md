...
URL Source: https://vercel.com/docs/integrations/cms/dato-cms

Markdown Content:
# Vercel DatoCMS Integration
[Skip to content](https://vercel.com/docs/integrations/cms/dato-cms#geist-skip-nav)
...
## [Getting started](https://vercel.com/docs/integrations/cms/dato-cms#getting-started)[](https://vercel.com/docs/integrations/cms/dato-cms#getting-started)

To get started with DatoCMS on Vercel, follow the steps below to install the integration:

1.   ### [Install the Vercel CLI](https://vercel.com/docs/integrations/cms/dato-cms#install-the-vercel-cli)[](https://vercel.com/docs/integrations/cms/dato-cms#install-the-vercel-cli) 
To pull in environment variables from DatoCMS to your Vercel project, you need to install the [Vercel CLI](https://vercel.com/docs/cli). Run the following command in your terminal:
 ...
 Terminal ![Image 3](https://7nyt0uhk7sse4zvn.public.blob.vercel-storage.com/docs-assets/static/topics/icons/pnpm.svg)        `pnpm i -g vercel@latest`     `yarn global add vercel@latest`     `npm i -g vercel@latest`     `bun add -g vercel@latest`   
2.   ### [Install your CMS integration](https://vercel.com/docs/integrations/cms/dato-cms#install-your-cms-integration)[](https://vercel.com/docs/integrations/cms/dato-cms#install-your-cms-integration) 
...
3.   ### [Pull in environment variables](https://vercel.com/docs/integrations/cms/dato-cms#pull-in-environment-variables)[](https://vercel.com/docs/integrations/cms/dato-cms#pull-in-environment-variables) 
...
### [Content Link](https://vercel.com/docs/integrations/cms/dato-cms#content-link)[](https://vercel.com/docs/integrations/cms/dato-cms#content-link)
...
[Previous Contentful](https://vercel.com/docs/integrations/cms/contentful)[Next Formspree](https://vercel.com/docs/integrations/cms/formspree)
