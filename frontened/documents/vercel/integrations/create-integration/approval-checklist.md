...
URL Source: https://vercel.com/docs/integrations/create-integration/approval-checklist

Markdown Content:
Before submitting your integration for review, work through the checklist that matches your integration type:

*   [Native integration](https://vercel.com/docs/integrations/create-integration/approval-checklist#native-integrations): Uses the Marketplace API and an integration server.
*   [Connectable account integration](https://vercel.com/docs/integrations/create-integration/approval-checklist#connectable-account-integrations): Uses a redirect URL and OAuth flow.

Complete the relevant checklist, then email [integrations@vercel.com](mailto:integrations@vercel.com) with your request to be reviewed.
...
1.   Email [integrations@vercel.com](mailto:integrations@vercel.com) with your request to be reviewed for listing.
