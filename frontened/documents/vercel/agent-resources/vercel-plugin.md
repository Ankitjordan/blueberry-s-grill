...
* [Claude Code](https://docs.anthropic.com/en/docs/claude-code), [Cursor](https://www.cursor.com), or [OpenAI Codex](https://openai.com/index/codex/) when support is available
* Node.js 18 or later
* [Bun](https://bun.sh)
