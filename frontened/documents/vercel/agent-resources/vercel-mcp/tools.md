...
To enhance security, enable human confirmation for tool execution and exercise
caution when using Vercel MCP alongside other servers to prevent prompt
injection attacks.

## [Documentation tools](#documentation-tools)

### [search\_documentation](#search_documentation)
...
### [list\_deployments](#list_deployments)
...
### [get\_deployment](#get_deployment)
...
### [get\_deployment\_build\_logs](#get_deployment_build_logs)
...
### [get\_runtime\_logs](#get_runtime_logs)
...
### [check\_domain\_availability\_and\_price](#check_domain_availability_and_price)
...
### [get\_access\_to\_vercel\_url](#get_access_to_vercel_url)
...
### [web\_fetch\_vercel\_url](#web_fetch_vercel_url)
...
### [list\_toolbar\_threads](#list_toolbar_threads)
...
### [get\_toolbar\_thread](#get_toolbar_thread)
...
### [change\_toolbar\_thread\_resolve\_status](#change_toolbar_thread_resolve_status)
...
### [reply\_to\_toolbar\_thread](#reply_to_toolbar_thread)
...
### [edit\_toolbar\_message](#edit_toolbar_message)
...
### [add\_toolbar\_reaction](#add_toolbar_reaction)
...
### [use\_vercel\_cli](#use_vercel_cli)
...
### [deploy\_to\_vercel](#deploy_to_vercel)
...
Vercel MCP server](/docs/agent-resources/vercel-mcp)[Next

Integrations for Agents](/docs/agent-resources/integrations-for-agents)
