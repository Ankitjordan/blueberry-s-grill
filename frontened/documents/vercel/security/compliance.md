...
The Vercel CDN and deployment platform primarily uses Amazon Web Services (AWS), and currently has 20 different [regions](/docs/regions) and an Anycast network with global IP addresses.
...
If you need isolated runtime infrastructure, you can use [Vercel Secure
...
These backups are not available to customers and are created for Vercel's
