...
## [Stage, test, and publish](#stage-test-and-publish)
...
## [Manage rules with the API](#manage-rules-with-the-api)
...
## [Differences from deployment-level routes](#differences-from-deployment-level-routes)
...
Rewrites](/docs/routing/rewrites)[Next

Security](/docs/cdn-security)
