...
## [How Domain Connect works with Vercel](#how-domain-connect-works-with-vercel)
...
## [Step 1: Discover the DNS provider](#step-1:-discover-the-dns-provider)
...
The settings endpoint returns a `404` if the domain is not using Vercel's
nameservers.

## [Step 2: Check template support](#step-2:-check-template-support)
...
## [Step 3: Build and sign the apply URL](#step-3:-build-and-sign-the-apply-url)
...
### [Signing the request](#signing-the-request)
...
### [Example apply URL](#example-apply-url)
...
## [Step 4: Handle the redirect](#step-4:-handle-the-redirect)
...
your-company.com.your-service.json
...
If you define a `CNAME` record at the root domain (`host: "@"`), Vercel
...
## [Onboard your template with Vercel](#onboard-your-template-with-vercel)
...
3. Submit your template to Vercel for review. Reach out to [domainconnect@vercel.com](mailto:domainconnect@vercel.com). Include a link to the template(s) and a short in-product video demonstrating the flow that uses Domain Connect.
...
Vercel requires all synchronous apply requests to be digitally signed. Make
sure your template includes `syncPubKeyDomain` and your public key is
accessible via DNS.

## [Troubleshooting](#troubleshooting)

### ["Domain not found" error](#domain-not-found-error)
...
### [Settings endpoint returns 404](#settings-endpoint-returns-404)
...
Learn how to add, verify, and remove DNS records for your domains on Vercel.](/docs/domains/managing-dns-records)

[#### Working with DNS

Understand how DNS works and how to configure your domain.](/docs/domains/working-with-dns)

[#### Managing nameservers

Learn how to update your domain's nameservers to Vercel.](/docs/domains/managing-nameservers)

[#### Domain Connect specification

Read the full Domain Connect protocol specification on GitHub.](https://github.com/Domain-Connect/spec)
