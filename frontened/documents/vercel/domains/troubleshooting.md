...
### [DNS record propagation times](#dns-record-propagation-times)
...
Before changing your DNS records to point to Vercel, we recommend updating
...
### [Domain IP address and geographic regions](#domain-ip-address-and-geographic-regions)
...
Supported Domains](/docs/domains/supported-domains)[Next

Set Up Custom Domain](/docs/domains/set-up-custom-domain)
