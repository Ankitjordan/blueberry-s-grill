...
## [vercel integration-resource create-threshold](#vercel-integration-resource-create-threshold)
...
The following [global options](/docs/cli/global-options) can be passed when using the `vercel integration-resource` command:
...
vercel integration](/docs/cli/integration)[Next
