...
## [Using Vercel Agent in GitHub](#using-vercel-agent-in-github)
...
### [Supported guideline files](#supported-guideline-files)
...
### [How guidelines are applied](#how-guidelines-are-applied)
...
### [Writing effective guidelines](#writing-effective-guidelines)
...
Chat](/docs/agent/chat)[Next

Managing Reviews](/docs/agent/pr-review/usage)
