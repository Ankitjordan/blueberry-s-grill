...
Frameworks with ISR SupportAPIs with Cache-Control HeadersImage OptimizationExternal Origins

Next.js, SvelteKit, and other frameworks use [Incremental Static Regeneration (ISR)](/docs/incremental-static-regeneration) to cache pre-rendered pages and update content on demand without redeploying.
...
[CDN Cache](/docs/caching/cdn-cache)Global across all Vercel regions for fast delivery

Function Region

[ISR Cache](/docs/incremental-static-regeneration)Can be revalidated on-demand or based on time

Vercel Function

[Runtime Cache](/docs/caching/runtime-cache)For data used in Vercel Functions
...
### [Incremental Static Regeneration (ISR) cache](#incremental-static-regeneration-isr-cache)
...
Incremental Static Regeneration](/docs/incremental-static-regeneration)[Next
