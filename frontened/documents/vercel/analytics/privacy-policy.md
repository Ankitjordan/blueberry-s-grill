...
Resilient Intake requires version 2 of the `@vercel/analytics` [package](/docs/analytics/package#whats-new-in-version-2).

---

[Previous

Redacting Sensitive Data](/docs/analytics/redacting-sensitive-data)[Next
