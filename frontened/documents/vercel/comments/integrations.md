...
Private Slack channels will not appear in the dropdown list when setting up
...
Your previous linked channels and subscriptions will continue to work even if
...
When a new comment is created on a deployment, the Vercel Slack app will create a matching thread in each of the subscribed Slack channels. The first post will include:
...
1. ### [Install the Vercel integration for your issue tracker](#install-the-vercel-integration-for-your-issue-tracker)
   ...
   * [GitHub](/marketplace/github)
   ...
   On Jira, issues will be marked as reported by the user who converted the
...
Managing Comments](/docs/comments/managing-comments)[Next
