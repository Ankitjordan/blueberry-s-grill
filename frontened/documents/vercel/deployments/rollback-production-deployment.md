...
This guide requires a [linked Vercel project](/docs/cli/project-linking). Run `vercel link` in your
...
## [1. Confirm the problem](#1.-confirm-the-problem)
...
## [2. Roll back immediately](#2.-roll-back-immediately)
...
On the Hobby plan, you can only roll back to the immediately previous
...
## [3. Verify service is restored](#3.-verify-service-is-restored)
...
## [4. Identify the bad deployment](#4.-identify-the-bad-deployment)
...
## [5. Check the build logs](#5.-check-the-build-logs)
...
## [6. Compare with the last known good deployment](#6.-compare-with-the-last-known-good-deployment)
...
## [7. Bisect if the cause spans multiple deployments](#7.-bisect-if-the-cause-spans-multiple-deployments)
...
## [8. Fix and deploy](#8.-fix-and-deploy)
...
## [9. Ship to production](#9.-ship-to-production)
...
## [Rolling back to a specific deployment](#rolling-back-to-a-specific-deployment)
...
Promote Preview to Production](/docs/deployments/promote-preview-to-production)[Next
