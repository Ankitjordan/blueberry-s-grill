...
You can use the Open Graph section in the sidebar on every deployment on Vercel to validate and view your [Open Graph (OG)](https://ogp.me/) data across a range of social media sites before you share it out. Routes using [Deployment Protection](/docs/deployments/deployment-protection) can also be inspected.
...
Claim Deployments](/docs/deployments/claim-deployments)[Next
