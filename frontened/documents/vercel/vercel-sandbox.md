...
* [Node.js and Python runtimes](/docs/vercel-sandbox/system-specifications#runtimes): Choose from `node26`, `node24`, `node22`, or `python3.13` with full root access. [Install any package or binary you need](/kb/guide/how-to-install-system-packages-in-vercel-sandbox).
...
* [Persistent sandboxes (beta)](/docs/vercel-sandbox/concepts/persistent-sandboxes): Sandboxes that auto-save state on stop and resume where you left off. No manual snapshot management needed.
* [Tags (beta)](/docs/vercel-sandbox/concepts/tags): Categorize sandboxes by environment, team, or any other criteria using key-value tags.
...
Create your first sandbox step by step.](/docs/vercel-sandbox/quickstart)[### Working with Sandbox

Task-oriented guides for common operations.](/docs/vercel-sandbox/working-with-sandbox)[### Concepts

Understand how sandboxes work under the hood.](/docs/vercel-sandbox/concepts)[### SDK Reference

Full API documentation for TypeScript and Python.](/docs/vercel-sandbox/sdk-reference)[### CLI Reference

Manage sandboxes from the command line.](/docs/vercel-sandbox/cli-reference)[### Pricing

Review costs and resource limits.](/docs/vercel-sandbox/pricing)[### Sandbox Repo

View the Sandbox repository on GitHub contained the SDK and CLI codebase.](https://github.com/vercel/sandbox)

---

[Previous

OG Image Generation](/docs/og-image-generation)[Next
