...
### [What gets bypassed](#what-gets-bypassed)
...
### [What doesn't get bypassed](#what-doesn't-get-bypassed)
...
## [Configuring Protection Bypass for Automation](#configuring-protection-bypass-for-automation)
...
![Protection Bypass for Automation option](/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdeployment-protection%2Fprotection-bypass-light.png&w=1920&q=75)![Protection Bypass for Automation option](/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fdeployment-protection%2Fprotection-bypass-dark.png&w=1920&q=75)

Protection Bypass for Automation option

## [Permissions for Protection Bypass for Automation](#permissions-for-protection-bypass-for-automation)
...
### [Method 1: HTTP header (recommended)](#method-1:-http-header-recommended)
...
### [Method 2: Query parameter](#method-2:-query-parameter)
...
For security, use an environment variable to store the bypass secret rather
...
#### [Slack bot webhook verification](#slack-bot-webhook-verification)
...
#### [Other webhook services](#other-webhook-services)
...
Trusted Sources](/docs/deployment-protection/methods-to-bypass-deployment-protection/trusted-sources)[Next
