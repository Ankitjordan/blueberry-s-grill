...
#### [Per-function `regions` and `functionFailoverRegions`](#per-function-regions-and-functionfailoverregions)
...
### [Deprecated route properties](#deprecated-route-properties)
...
### [Conditional matching with `has` and `missing`](#conditional-matching-with-has-and-missing)
...
### [Using environment variables in routes](#using-environment-variables-in-routes)
...
#### [In route destinations](#in-route-destinations)
...
### [Routes vs higher-level properties](#routes-vs-higher-level-properties)
...
Project Configuration](/docs/project-configuration)[Next
