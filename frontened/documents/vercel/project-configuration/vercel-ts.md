...
### [Install @vercel/config](#install-@vercel/config)
...
### [Migrating from vercel.json](#migrating-from-vercel.json)
...
## [Config export options](#config-export-options)
...
vercel.json](/docs/project-configuration/vercel-json)[Next
