...
#### [Cache tag case sensitivity](#cache-tag-case-sensitivity)

Cache tags are case-sensitive, meaning `product` and `Product` are treated as different tags.

#### [Cache tag allowed characters](#cache-tag-allowed-characters)
...
## [Programmatically purging CDN Cache](#programmatically-purging-cdn-cache)
...
## [Manually purging Vercel CDN Cache](#manually-purging-vercel-cdn-cache)
