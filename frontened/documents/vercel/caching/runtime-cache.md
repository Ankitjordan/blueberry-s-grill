...
Runtime Cache is available on [all plans](/docs/plans)
...
For caching complete HTTP responses (entire pages, API responses) in Vercel regions, see [CDN cache](/docs/cdn-cache). For caching build artifacts, see [Remote cache](/docs/monorepos/remote-caching).

## [When to use runtime cache](#when-to-use-runtime-cache)
...
## [How runtime cache works](#how-runtime-cache-works)
...
## [Using runtime cache](#using-runtime-cache)
...
### [Runtime cache with any framework](#runtime-cache-with-any-framework)
...
### [Runtime cache with Next.js](#runtime-cache-with-next.js)
...
### [Next.js 16 and above](#next.js-16-and-above)
...
#### [Using use cache: remote](#using-use-cache:-remote)
...
#### [Using fetch with force-cache](#using-fetch-with-force-cache)
...
#### [Using fetch with cache options](#using-fetch-with-cache-options)
...
#### [Using unstable\_cache](#using-unstable_cache)
...
### [Next.js 14 and below](#next.js-14-and-below)
...
The Next.js examples are for Next.js 15 and above. For Next.js 14 and below, see [Data Cache](/docs/runtime-cache/data-cache).
...
## [Working with CDN cache](#working-with-cdn-cache)
...
CDN Cache](/docs/caching/cdn-cache)[Next

Data Cache](/docs/caching/runtime-cache/data-cache)
