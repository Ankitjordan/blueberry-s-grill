...
We highly recommend enabling [Skew Protection](/docs/skew-protection) with
...
A stage configured for 0% of traffic is a special case. Vercel will not
...
Be aware that anybody is capable of setting `vcrrForceCanary=true` on a URL.
...
### [Stopping a rolling release with the API or SDK](#stopping-a-rolling-release-with-the-api-or-sdk)
...
Restricting Git Connections to a single Vercel team](/docs/protected-git-scopes)[Next

Rolling Release Deployment](/docs/rolling-releases/rolling-release-deployment)
