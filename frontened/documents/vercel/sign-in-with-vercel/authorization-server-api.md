...
| `state` | No | A random string generated by the application that is used to protect against CSRF attacks. |
...
## [Revoke Token Endpoint](#revoke-token-endpoint)
...
Tokens](/docs/sign-in-with-vercel/tokens)[Next
