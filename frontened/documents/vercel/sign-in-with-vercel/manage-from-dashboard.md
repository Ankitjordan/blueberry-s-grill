...
## [Choose your client authentication method](#choose-your-client-authentication-method)
...
## [Configure the authorization callback URL](#configure-the-authorization-callback-url)
...
## [Configure the necessary permissions](#configure-the-necessary-permissions)
...
Authorization Server API](/docs/sign-in-with-vercel/authorization-server-api)[Next
