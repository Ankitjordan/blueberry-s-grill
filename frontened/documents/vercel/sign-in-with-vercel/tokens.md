...
### [JWT claims in ID Tokens](#jwt-claims-in-id-tokens)
...
### [Scope dependent claims](#scope-dependent-claims)
...
## [Securing your tokens](#securing-your-tokens)
...
Scopes & Permissions](/docs/sign-in-with-vercel/scopes-and-permissions)[Next
