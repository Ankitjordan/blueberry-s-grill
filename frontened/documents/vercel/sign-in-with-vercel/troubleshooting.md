...
## [Authorization endpoint errors](#authorization-endpoint-errors)

These errors occur when users navigate to the authorization endpoint with invalid parameters.

### [Missing or invalid client\_id](#missing-or-invalid-client_id)
...
### [Missing or invalid redirect\_uri](#missing-or-invalid-redirect_uri)
...
### [Missing response\_type](#missing-response_type)
...
### [Invalid response\_type](#invalid-response_type)
...
### [Invalid code\_challenge length](#invalid-code_challenge-length)
...
### [Invalid prompt parameter](#invalid-prompt-parameter)
...
Consent Page](/docs/sign-in-with-vercel/consent-page)[Next
