...
| --- | --- | --- |
| [Edge Config Reads](/docs/edge-config/using-edge-config) | First 100,000 | $3.00/1,000,000 Reads |
| [Edge Config Writes](/docs/edge-config/using-edge-config) | First 100 | $1.00/100 Writes |
...
| --- | --- | --- | --- |
| [Maximum store size](#maximum-store-size) | 8 KB | 64 KB | 512 KB  Can request higher limit by [contacting Vercel Support](/help) |
| [Maximum number of stores (total)](#maximum-number-of-stores) | 1 | 3 | 10  Can request higher limit by [contacting Vercel Support](/help) |
...
Edge Config SDK](/docs/edge-config/edge-config-sdk)[Next
