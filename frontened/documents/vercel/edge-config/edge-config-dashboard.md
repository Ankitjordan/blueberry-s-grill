...
Vercel shows the full token and connection string only once, right after
...
Using the Vercel REST API, you can create and update Edge Configs](/docs/edge-config/vercel-api)

---

[Previous

Edge Configs & REST API](/docs/edge-config/vercel-api)[Next
