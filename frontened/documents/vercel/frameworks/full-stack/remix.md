...
URL Source: https://vercel.com/docs/frameworks/full-stack/remix
...
It is highly recommended that your application uses the Remix Vite plugin, in conjunction with the [Vercel Preset](https://vercel.com/docs/frameworks/full-stack/remix#vercel-vite-preset), when deploying to Vercel.
