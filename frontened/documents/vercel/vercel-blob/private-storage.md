...
* `@vercel/blob` [TypeScript SDK](/docs/vercel-blob/using-blob-sdk) >= 2.3
...
## [Creating a private Blob store](#creating-a-private-blob-store)
...
## [Delivering private blobs](#delivering-private-blobs)
...
## [Accessing without the SDK](#accessing-without-the-sdk)
