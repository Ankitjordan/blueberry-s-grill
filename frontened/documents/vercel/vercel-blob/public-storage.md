...
## [Creating a public Blob store](#creating-a-public-blob-store)
...
## [Delivering public blobs](#delivering-public-blobs)
...
`next/image` with direct blob URLs only works with public Blob stores. For
...
### [Linking a file for download](#linking-a-file-for-download)
...
### [Browser caching with conditional requests](#browser-caching-with-conditional-requests)
...
## [Download charges](#download-charges)
...
Private Storage](/docs/vercel-blob/private-storage)[Next
