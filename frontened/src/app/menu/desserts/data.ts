...
export const DESSERT_DATA: DessertItem[] = [
  ...
  },
  {
    ...
    description: "A refreshing and vibrant waffle experience topped with a mountain of fresh berries and silken cream.",
  },
  {
    ...
    description: "Indulgent thick-cut brioche French toast layered with rich chocolate and sweet caramelized bananas.",
  },
  {
    id: "pancake",
    name: "Pancake",
    ...
    description: "Classic, perfectly fluffy buttermilk pancakes served with premium maple syrup and artisanal butter.",
  },
];
