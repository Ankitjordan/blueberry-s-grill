...
export const ImageBackgroundZoom = ({
	src,
	alt,
	children,
}: ImageBackgroundZoomProps) => {
	...
	return (
		<>
			<div
				ref={triggerRef}
				onClick={handleZoom}
				className="relative cursor-zoom-in group overflow-hidden rounded-2xl border border-slate-200"
			>
				<motion.img
					src={src}
					alt={alt}
					...
					{isZoomed && (
						...
						>
							...
							>
								...
								<div className="absolute bottom-0 left-0 right-0 p-12 bg-gradient-to-t from-black via-black/60 to-transparent content-overlay">
									<motion.div
