              ...
              >
                ...
                <ImageBackgroundZoom src={img.src} alt={img.name}>
                  ...
                  <div className="absolute top-4 left-4">
                    {" "}
                    <span className="px-3 py-1 rounded-full bg-black/60 backdrop-blur-md border border-white/10 text-[9px] font-black uppercase tracking-widest text-[#D4AF37]">
                      {" "}
                      0{i + 1}{" "}
                    </span>{" "}
                  </div>{" "}
                ...
                <div className="space-y-3 px-2">
                  {" "}
                  <h3 className="text-xl font-black uppercase tracking-tighter text-white group-hover:text-[#D4AF37] transition-colors">
                    {" "}
                    {img.name}{" "}
                  </h3>{" "}
