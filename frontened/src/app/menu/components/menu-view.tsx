    ...
    <>
      ...
      {!isSidebarOpen && (
        <motion.button
          ...
          className="fixed left-6 md:left-12 top-[100px] z-[45] flex items-center gap-4 bg-[#0A0A0A]/80 backdrop-blur-md border border-white/10 py-3 px-5 rounded-full hover:border-[#D4AF37]/50 transition-all duration-300 shadow-2xl group"
        >
