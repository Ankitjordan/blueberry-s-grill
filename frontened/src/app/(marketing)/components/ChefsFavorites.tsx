...
const MENU_ITEMS: MenuItem[] = [
	{
		...
		badge: "BEST SELLER",
		badgeColor: "bg-[#ff5500] text-black",
		name: "The OG Burger",
		price: "$14",
		description:
...
const MenuCard: React.FC<MenuCardProps> = ({ item }) => {
	return (
		<article className="group flex flex-col border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-[2px] hover:-translate-y-[2px] transition-all duration-200 bg-white overflow-hidden">
			{/* Image Wrapper */}
