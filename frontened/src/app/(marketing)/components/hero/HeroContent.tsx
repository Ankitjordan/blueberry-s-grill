	...
	return (
		<div className="flex-1 flex flex-col items-center justify-center w-full h-full z-10 mt-[80px] text-center px-4">
			...
			>
				...
				<motion.h1
					variants={itemVariants}
					className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-white leading-[1.1] drop-shadow-[0_2px_20px_rgba(0,0,0,0.6)]"
				>
					Savor the True <br />
					<span className="text-yellow-400 italic font-serif font-light pr-2 tracking-[1px] drop-shadow-[0_5px_20px_rgba(250,204,21,0.5)]">
						Taste
					</span>
					of Excellence
				</motion.h1>
				...
				<motion.p
					variants={itemVariants}
					className="text-white/90 text-sm md:text-base lg:text-lg max-w-2xl font-light tracking-wide leading-relaxed drop-shadow-md"
				>
					Discover a vibrant harvest of fresh flavors, premium cuts, and
					unforgettable dining experiences. Blueberry&apos;s Grill offers a
					modern twist on classic coastal cuisine in an elegant, airy
					atmosphere.
				</motion.p>
