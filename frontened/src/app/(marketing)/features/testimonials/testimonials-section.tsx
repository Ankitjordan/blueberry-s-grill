...
/**
 * Gallery layout plan — 3-column grid, each row = 200px fixed.
 * Each item declares: col-span (1|2|3) × row-span (1|2)
 *
 *  [col-span-2 row-span-1] [col-span-1 row-span-2]   ← row 1
 *  [col-span-1 row-span-1] [col-span-1 row-span-1]   ← row 2  (fills col 1-2 from above)
 *  [col-span-1 row-span-2] [col-span-2 row-span-1]   ← row 3
 *  [col-span-1 row-span-1] [col-span-1 row-span-1]   ← row 4  (fills col 2-3 from above)
 *  [col-span-3 row-span-1]                            ← row 5  full-width
 *  [col-span-1 row-span-1] [col-span-1 row-span-1] [col-span-1 row-span-1]  ← row 6
 *  [col-span-2 row-span-1] [col-span-1 row-span-2]   ← row 7
 *  [col-span-2 row-span-1]                            ← row 8  (fills col 1-2, col-3 from above)
 */
const galleryImages = [
  { src: "/images/enhanced_interior/interior-1.png", span: "col-span-2 row-span-1" },
  { src: "/images/enhanced_interior/interior-2.png", span: "col-span-1 row-span-2" },
  { src: "/images/interior/interior_6.jpg",           span: "col-span-1 row-span-1" },
  { src: "/images/enhanced_interior/interior-3.png", span: "col-span-1 row-span-1" },
  { src: "/images/interior/interior_5.jpg",           span: "col-span-1 row-span-2" },
  { src: "/images/enhanced_interior/interior-4.png", span: "col-span-2 row-span-1" },
  ...
  { src: "/images/enhanced_interior/interior-5.png", span: "col-span-3 row-span-1" },
  { src: "/images/interior/interior_1.jpg",           span: "col-span-1 row-span-1" },
  { src: "/images/enhanced_interior/interior-6.png", span: "col-span-1 row-span-1" },
  { src: "/images/interior/interior_2.jpg",           span: "col-span-1 row-span-1" },
  { src: "/images/enhanced_interior/interior-7.png", span: "col-span-2 row-span-1" },
...
const TestimonialItem = ({
  ...
  <motion.div
    ...
    className="group relative bg-white border border-slate-100 p-5 rounded-[1.75rem] shadow-sm transition-all duration-500 hover:shadow-xl hover:shadow-[#D4AF37]/10 hover:-translate-y-0.5 flex flex-col"
  >
    {/* Decorative quote */}
    <div className="absolute top-5 right-5 opacity-[0.04] pointer-events-none">
      <svg width="48" height="48" viewBox="0 0 24 24" fill="currentColor" className="text-[#D4AF37]">
...
/**
 * GalleryTile — pure-CSS hover effect, no JS animation library.
 * Using CSS transitions removes Framer Motion JS overhead for 15 decorative tiles.
 */
const GalleryTile = ({ src, span, index }: { src: string; span: string; index: number }) => (
  <div
  ...
  >
    ...
    />
    {/* constant base gradient for visual depth */}
    <div className="absolute inset-0 bg-gradient-to-t from-black/35 via-transparent to-transparent" />
    {/* hover reveal overlay */}
    <div className="absolute inset-0 bg-black/25 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-5">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row relative z-10">
        ...
        <div className="w-full lg:w-[45%] p-8 md:p-12 lg:p-16 flex flex-col justify-center">
          <div className="max-w-xl mx-auto lg:mx-0 space-y-10">
            ...
            <div className="space-y-4">
              ...
              >
                Real stories from guests who&apos;ve made Blueberry&apos;s Grill a part
                of their most cherished moments.
              </motion.p>
            </div>
        ...
        {/* ── RIGHT: Gallery ──
            3-column grid with fixed 200px row height.
            Every cell is explicitly sized via col/row span — no flow-dense tricks.
            overflow-hidden clips any trailing overflow from the last rows.
        */}
        <div className="w-full lg:w-[55%] self-stretch relative overflow-hidden min-h-[600px]">
          <div
          ...
          >
            {galleryImages.map((img, idx) => (
              <GalleryTile key={idx} src={img.src} span={img.span} index={idx} />
            ))}
          </div>
        </div>
      </div>
        ...
        {selectedTestimonial && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-[2.5rem] p-8 md:p-10 max-w-xl w-full relative shadow-2xl overflow-hidden"
            ...
            >
              ...
              <div className="relative">
                <div className="absolute -top-4 -left-4 opacity-[0.05] pointer-events-none">
                  <svg width="100" height="100" viewBox="0 0 24 24" fill="currentColor" className="text-[#D4AF37]">
                    <path d="M14.017 21L14.017 18C14.017 16.8954 14.9124 16 16.017 16H19.017C19.5693 16 20.017 15.5523 20.017 15V9C20.017 8.44772 19.5693 8 19.017 8H15.017C14.4647 8 14.017 8.44772 14.017 9V12C14.017 12.5523 13.5693 13 13.017 13H11.017V21H14.017ZM5.017 21L5.017 18C5.017 16.8954 5.91243 16 7.017 16H10.017C10.5693 16 11.017 15.5523 11.017 15V9C11.017 8.44772 10.5693 8 10.017 8H6.017C5.46472 8 5.017 8.44772 5.017 9V12C5.017 12.5523 4.56929 13 4.017 13H2.017V21H5.017Z" />
                  </svg>
                </div>
