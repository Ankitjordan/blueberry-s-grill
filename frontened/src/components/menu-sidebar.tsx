      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed top-0 md:top-[73px] left-0 w-full sm:w-80 bg-[#0A0A0A] border-r border-white/10 h-full md:h-[calc(100vh-73px)] z-[9999] shadow-[20px_0_50px_rgba(0,0,0,0.5)] overflow-y-auto"
          >
                    ...
                    return (
                      <button
                        ...
                        className={`group relative w-full py-4 px-6 text-left text-[11px] md:text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 rounded-xl ${
                          isActive ? "text-[#D4AF37] bg-white/5" : "text-gray-400 hover:text-white hover:bg-white/[0.02]"
                        }`}
                      >
                        {isActive && (
                          <motion.div
