...
const VARIANTS = {
	...
	circle:
		"w-24 h-24 sm:w-32 sm:h-32 bg-[#2d3bfe] text-white font-bold border-2 border-black rounded-full flex items-center justify-center text-center p-2 text-sm sm:text-base leading-tight",
};
